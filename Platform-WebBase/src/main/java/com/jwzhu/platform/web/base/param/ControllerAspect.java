...
import com.jwzhu.platform.web.base.exception.JsonException;
import com.jwzhu.platform.web.base.exception.PageException;
import com.jwzhu.platform.web.base.request.RequestBaseParam;
import com.jwzhu.platform.web.base.request.RequestType;
import com.jwzhu.platform.web.base.request.RequestUtil;
...
public class ControllerAspect {
    ...
    private void analyzeToken() {
        ...
        if (!StringUtils.isEmpty(token)) {
            ...
            RequestBaseParam.setNewToken(tokenService.updateToken(subject));
